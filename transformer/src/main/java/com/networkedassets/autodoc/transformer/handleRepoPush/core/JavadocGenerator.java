...
public class JavadocGenerator implements DocumentationGenerator {
	...
	public Documentation generateFrom(Code code) {
		try {
			// TODO: Documentation object shouldn't receive the path of the
			// docs, but the docs themselves
			return new Documentation(Javadoc.fromDirectory(code.getCodePath(), null, null).toString());
