...
public class Javadoc {
	 ...
	 *            directory where the docs are going to be located
	 * @param sourceFiles
	 *            source files for docs generation
	 */
	 ...
	 *
	 * @param scmServer
	 *            server given project is located on
	 ...
	 *
	 * @param localDirectory
	 *            the directory javadoc should be generated for
	 * @return the location of the javadoc (subdirectory of the localDirectory)
	 * @throws JavadocException
	 */
	@Nonnull
	...
	public void generate() throws JavadocException {
		Stream<String> args = Stream.concat(
				Stream.of(javadocExecutablePath, // javadoc
						"-d", javadocDirectory.toString()), // -d ./javadoc/
				sourceFiles.stream().map(Path::toString)); // ./src/com/example/File1.java
															// ./src/com/example/File2.java
	 ...
	 *
	 * @param javaFiles
	 *            collection of files to be added
	 */
