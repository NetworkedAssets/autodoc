...
public class BinderTest extends JerseyTest {
	...
	/**
	 * invokes RESTful resource to obtain class name injected in Resource class
	 * and compare its equality
	 * 
	 * @param codeProvider
	 */
	...
	/**
	 * RESTful resource using to @Inject different classes and compare class
	 * name passed in URI to injected class name
	 */
	@Path("/example")
